...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=XqYRjARY#SEeUQTWWK1Z093o2QulNdqk3UTvExV1qzCkscfBjmMY' : process.env.SESSION_ID,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "gayanboy11@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "boys@2003" : process.env.SEEDER_PASSWORD,
